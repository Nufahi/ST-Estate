...
const STRINGS = {
    en: {
        ...
        languageNote: 'Applies to the entry text. Keywords and visual tags are always English.',
    ...
    ru: {
        ...
        languageNote: 'Относится к тексту записи. Ключи и визуальные теги всегда английские.',
